                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('clientes.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('nombre')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('email')
                            <span class="text-sm text-red-500">{{ $message }}</span>
                        @enderror
                        </div>
