                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('citas.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="fecha" id="fecha" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('fecha')
                                <span class="text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="hora" id="hora" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('hora')
                                <span class="text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="costo" id="costo" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('costo')
                                <span class="text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
