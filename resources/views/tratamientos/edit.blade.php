                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('tratamientos.update', $tratamiento->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tratamiento" id="tratamiento" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" value="{{ $tratamiento->tratamiento }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="descripcion" class="block text-sm font-medium text-gray-700">Descripción</label>
                            <textarea name="descripcion" id="descripcion" rows="4" class="block w-full p-2 mt-1 border border-gray-400 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>{{ $tratamiento->descripcion }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" name="costo" id="costo" class="block w-full p-2 border border-gray-400 rounded-r-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" value="{{ $tratamiento->costo }}" required>
                            </div>
                        </div>
